            ...
            <div class="col-md-12">
                <div class="mu-page-breadcrumb-area">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">নোটিশ  ডিটেলস</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="mu-course-container">
                                <div class="panel panel-default">
                                    <div class="panel-heading">{{ $single_notice->title ?: '-' }}</div>
                                    <div class="panel-body">{!! $single_notice->description ?: '-'  !!}</div>
                                    <div class="panel-footer">
                                        <iframe width="720" height="600" src="{{ asset($single_notice->attachment) }}">
