...
@section('main-section')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Create institute committee</h5>

            <!-- Vertical Form -->
            <form action="{{ route('institute-treasure-save') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-12">
