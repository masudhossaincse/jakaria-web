...
@section('main-section')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- Vertical Form -->
            <form action="{{ route('gallery-save') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <input name="photos[]" type="file" class="form-control" id="inputAddress" multiple>
                </div>
